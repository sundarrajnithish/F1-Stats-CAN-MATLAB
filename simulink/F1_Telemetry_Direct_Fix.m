% F1_Telemetry_Direct_Fix.m - Creates a Simulink model that directly decodes
% CAN messages from the receiver without needing a DBC file
...
try
    ...
    set_param([modelName, '/WARNING'], 'DisplayLabel', '"SIMULATED DATA (NOT LIVE CAN)"');
...
% Try to create a simple dashboard if possible
try
    ...
    warning('Could not create dashboard. This is an optional feature.');
end
...
fprintf('\n✅ F1_Telemetry_Sim model has been created successfully!\n\n');
